<header class="header" id="header">
  <nav class="nav container">
    <a href="{{ route('home') }}" class="nav__logo">TRAVELNOW</a>
    ...
    <div class="nav__menu" id="nav-menu">
      <ul class="nav__list">
          ...
          <li class="nav__item dropdown">
            ...
            <ul class="dropdown-menu" id="dropdownMenu">
              @if(!Auth::user()->is_admin)
                <li><a href="{{ route('history') }}">Vé của tôi</a></li>
              @else
        ...
        @else
          ...
          <li class="nav__item">
            <a href="{{ route('register.form') }}" class="nav__link">
              <i class="bx bx-user-plus nav__icon"></i>
              <span class="nav__name">Đăng ký</span>
            </a>
          </li>
        @endif
        <style>
